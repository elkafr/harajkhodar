...
import 'package:harajkhodar/ui/account/edit_password_screen.dart';
import 'package:harajkhodar/ui/account/edit_personal_info_screen.dart';
...
class _PersonalInformationScreenState extends State<PersonalInformationScreen> {
 ...
 void _defaultImageCLick() async {
   ...
   final results = await _apiProvider
       .postWithDio("https://harajkhodhar.com/api/default_photo"+ "?api_lang=${_authProvider.currentLang}", body: formData);
   setState(() => _isLoading = false);
               ...
               Positioned(
                 ...
                 child:  GestureDetector(
                   onTap: () async{
                       ...
                       final results = await _apiProvider
                           .post("https://harajkhodhar.com/api/default_photo/", body: {
                         "user_id": _authProvider.currentUser.userId,
                       });
